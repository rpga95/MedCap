...
//////THERMOMETER///////////////////////////////
 ...
 //BT////////
  ...
  if (sysTime > sysCompThresh){
     sendSysTime = sysTime;
  }
  if (diaTime > diaCompThresh){
     sendDiaTime = diaTime;
  }
  
  if (sendData){
    sprintf(buf, "%i,%i,%i,%i",round(sendSysTime),round(sendDiaTime),round(maxima),round(coreTemp*10));
  }else{
