...
float val[5];
  ...
  void setup(){
    ...
    ///////BT///////
    SimbleeForMobile.deviceName = "MedCap";
...
//////THERMOMETER///////////////////////////////
 ...
 //BT////////
  ...
  if (maxima > 512) data[1] = (float)maxima;
  data[2] = (float)minima;
...
void ui(){
  ...
  SimbleeForMobile.drawText(65+i,110,"pk",BLACK,24);
  SimbleeForMobile.drawText(65+(2*i),110,"tr",BLACK,24);
